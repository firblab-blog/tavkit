    ...
    <div className="space-y-6">
      ...
      {hasValidDialogueTree(dialogue.dialogue_tree) && (
        <div>
          ...
          <DialogueOption
            option={dialogue.dialogue_tree.friendly}
            type="friendly"
          />
          <DialogueOption
            option={dialogue.dialogue_tree.neutral}
            type="neutral"
          />
          <DialogueOption
            option={dialogue.dialogue_tree.hostile}
            type="hostile"
          />
        </div>
      )}
      ...
      {dialogue._raw && (
        <RawDataViewer data={dialogue._raw} defaultExpanded={showRawResponse} />
      )}
