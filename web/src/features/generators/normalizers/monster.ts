...
function normalizeAbilities(value: unknown): MonsterAbilities {
  const defaults: MonsterAbilities = { STR: 10, DEX: 10, CON: 10, INT: 10, WIS: 10, CHA: 10 }
...
export function normalizeMonsterResponse(raw: Record<string, unknown>): GeneratedMonsterData {
