...
export function normalizeChaseResponse(raw: Record<string, unknown>): GeneratedChaseData {
  ...
  const result: GeneratedChaseData = {
    ...
    chase_type: String(processedRaw.chase_type || processedRaw.type || 'foot_chase'),
    terrain: String(processedRaw.terrain || processedRaw.environment || 'urban'),
