 ...
 */
export function normalizeTrapResponse(raw: Record<string, unknown>): GeneratedTrapData {
  ...
  if (raw.description && typeof raw.description === 'string') {
    ...
    if (descStr.startsWith('{') && descStr.endsWith('}')) {
      try {
        ...
        logger.debug('[TrapNormalizer] Parsed trap from JSON description:', parsedTrap)
