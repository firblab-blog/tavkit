...
export function hasValidDialogueContent(
  dialogue: GeneratedDialogueData | null,
): boolean {
...
export function normalizeDialogueResponse(
  ...
  return {
    ...
    potential_quests: raw.potential_quests
      ? normalizeStringArray(raw.potential_quests)
      : undefined,
    _raw:
