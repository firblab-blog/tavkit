...
export function normalizeQuestResponse(raw: Record<string, unknown>): GeneratedQuestData {
  ...
  if (raw.description && typeof raw.description === 'string') {
    ...
    if (descStr.startsWith('{') && descStr.endsWith('}')) {
      try {
        ...
        logger.debug('[normalizeQuest] Parsed quest from JSON description:', parsedQuest)
