...
import { difficultyOptions, encounterEnvironmentOptions, encounterTypeOptions } from '../schemas/encounter'
    ...
    <>
      ...
      <FormField label="Encounter Type">
        <select
          ...
          onChange={(e) => setFormData((prev) => ({ ...prev, encounter_type: e.target.value }))}
          className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:ring-2 focus:ring-primary"
        >
