...
import { merchantTypeOptions, type ManualMerchantData } from '../schemas/merchant'

interface MerchantManualFormProps {
  campaignId: string | null
  onCampaignSelect: (id: string | null) => void
  manualData: ManualMerchantData
  setManualData: (data: ManualMerchantData | ((prev: ManualMerchantData) => ManualMerchantData)) => void
  onSave: () => void
  saving: boolean
  saved: boolean
  error: string | null
