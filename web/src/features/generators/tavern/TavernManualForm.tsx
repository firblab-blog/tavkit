...
import { tavernTypeOptions, tavernSizeOptions, type ManualTavernData } from '../schemas/tavern'

interface TavernManualFormProps {
  campaignId: string | null
  onCampaignSelect: (id: string | null) => void
  manualData: ManualTavernData
  setManualData: (data: ManualTavernData | ((prev: ManualTavernData) => ManualTavernData)) => void
  onSave: () => void
  saving: boolean
  saved: boolean
  error: string | null
