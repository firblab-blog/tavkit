    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-3">
        <FormField label="Chase Type">
          <select
            ...
            onChange={(e) =>
              setManualData((prev) => ({ ...prev, chase_type: e.target.value }))
            }
            className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:ring-2 focus:ring-primary"
          >
        ...
        <FormField label="Terrain">
          <select
            ...
            onChange={(e) =>
              setManualData((prev) => ({ ...prev, terrain: e.target.value }))
            }
            className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:ring-2 focus:ring-primary"
          >
        ...
        <FormField label="Difficulty">
          <select
            ...
            onChange={(e) =>
              setManualData((prev) => ({ ...prev, difficulty: e.target.value }))
            }
            className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:ring-2 focus:ring-primary"
          >
      ...
      <FormField label="Setting">
        <input
          ...
          onChange={(e) =>
            setManualData((prev) => ({ ...prev, setting: e.target.value }))
          }
        ...
        <div className="space-y-3">
          <FormField label="Quarry (Being Chased)">
            <input
              ...
              onChange={(e) =>
                setManualData((prev) => ({ ...prev, quarry: e.target.value }))
              }
          ...
          <FormField label="Pursuers">
            <input
              ...
              onChange={(e) =>
                setManualData((prev) => ({ ...prev, pursuers: e.target.value }))
              }
          ...
          {manualData.obstacles.map((obstacle, idx) => (
            ...
            >
              ...
              <textarea
                ...
                onChange={(e) =>
                  updateObstacle(idx, { description: e.target.value })
                }
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  onChange={(e) =>
                    updateObstacle(idx, { check: e.target.value })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateObstacle(idx, { failure: e.target.value })
                  }
      ...
      <CollapsibleSection title="Complications" defaultExpanded={false}>
        <ArrayFieldEditor
          ...
          onChange={(complications) =>
            setManualData((prev) => ({ ...prev, complications }))
          }
          ...
          {manualData.shortcuts.map((shortcut, idx) => (
            ...
            >
              ...
              <textarea
                ...
                onChange={(e) =>
                  updateShortcut(idx, { description: e.target.value })
                }
                placeholder="Description"
                className="w-full px-3 py-1.5 bg-background border border-border rounded text-text text-sm focus:outline-none focus:ring-1 focus:ring-primary resize-none"
                rows={2}
              ...
              <input
                ...
                onChange={(e) =>
                  updateShortcut(idx, { benefit: e.target.value })
                }
