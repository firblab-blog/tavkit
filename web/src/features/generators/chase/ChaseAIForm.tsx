...
import { chaseTypeOptions, chaseDifficultyOptions, chaseTerrainOptions } from '../schemas/chase'
    ...
    <>
      ...
      <FormField label="Chase Type">
        <select
          ...
          onChange={(e) => setFormData((prev) => ({ ...prev, chase_type: e.target.value }))}
      ...
      <FormField label="Terrain">
        <select
          ...
          onChange={(e) => setFormData((prev) => ({ ...prev, terrain: e.target.value }))}
          className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:ring-2 focus:ring-primary"
        >
