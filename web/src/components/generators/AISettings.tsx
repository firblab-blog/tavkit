        ...
        <div className="px-4 pb-4 space-y-4 border-t border-border pt-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {Object.entries(DETAIL_LEVELS).map(
                ([key, { label, description }]) => (
                  <button
                    key={key}
                    onClick={() =>
                      setDetailLevel(key as AIGenerationSettings["detailLevel"])
                    }
            ...
            <p className="text-xs text-text-secondary mt-2">
              {DETAIL_LEVELS[detailLevel].description} • {getTokenCount()}{" "}
              tokens
              <span className="text-amber-500 ml-2">
                {DETAIL_LEVELS[detailLevel].warning}
              </span>
            </p>
          </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-0.5">
                  <li>
                    Higher detail levels generate more comprehensive content
                  </li>
                  <li>
                    Too low settings may cause incomplete/truncated results
                  </li>
