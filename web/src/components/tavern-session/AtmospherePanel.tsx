...
export default function AtmospherePanel({
  ...
  const currentTime = TIME_OF_DAY.find(
    (t) => t.value === encounter.time_of_day,
  );
      ...
      <div>
        ...
        <div className="mt-2 h-2 bg-background rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${
                (CROWD_SIZE.findIndex((c) => c.value === encounter.crowd_size) +
                  1) *
