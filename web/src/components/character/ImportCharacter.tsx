...
export default function ImportCharacter({
  ...
  const handleImport = async () => {
    ...
    try {
      const payload: { url: string; campaign_id?: string } = {
        url: characterUrl,
      };
      if (campaignId) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-text-muted mt-2">
          Enter the URL of your D&D Beyond character. You can find this in your
          browser's address bar when viewing your character sheet.
        </p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm text-blue-300">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-300/80">
              <li>
                Your character must be set to <strong>public</strong> on D&D
                Beyond
              </li>
              <li>This will create a new character in your Guild Roster</li>
              <li>
                All character data will be imported including stats, items, and
                features
              </li>
              <li>
                Updates on D&D Beyond won't automatically sync - reimport to
                update
              </li>
            </ul>
          </div>
