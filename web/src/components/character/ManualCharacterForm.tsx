...
export default function ManualCharacterForm({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (formData.class_info.trim())
        payload.class_info = formData.class_info.trim();
      ...
      // Ability scores
      if (formData.strength !== "" && formData.strength > 0)
        payload.strength = formData.strength;
      ...
      if (formData.wisdom !== "" && formData.wisdom > 0)
        payload.wisdom = formData.wisdom;
      if (formData.charisma !== "" && formData.charisma > 0)
        payload.charisma = formData.charisma;
      ...
      if (formData.speed !== "" && formData.speed > 0)
        payload.speed = formData.speed;
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              handleInputChange("allies_organizations", e.target.value)
            }
      ...
      <div className="bg-blue-900/20 border border-blue-500/50 rounded-lg p-4">
        <div className="flex gap-3">
          ...
          <div className="text-sm text-blue-300">
            <p>
              Only the character name is required. You can fill in other details
              now or edit them later.
            </p>
          </div>
        </div>
      </div>
