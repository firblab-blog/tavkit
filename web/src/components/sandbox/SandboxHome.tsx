...
function GeneratorCard({ label, path, icon, description, color }: GeneratorCardProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-text">Personal Library</h1>
            </div>
            <p className="text-text-muted">
              Create content without a campaign. Assign to campaigns later from Saved Content.
            </p>
          </div>
        </div>
        ...
        <div className="bg-background-panel border border-border rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm mt-1">
              Content created here goes to your Personal Library. Use the "Assign to Campaign"
              button in Saved Content to move items to a specific campaign.
            </p>
          </div>
        </div>
      </div>
