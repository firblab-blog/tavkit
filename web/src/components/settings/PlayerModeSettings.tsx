  ...
  const playerGenerators = [
    {
      id: "npc",
      label: "NPCs",
      description: "Create characters for your backstory",
    },
    {
      id: "location",
      label: "Locations",
      description: "Design places from your past",
    },
    {
      id: "item",
      label: "Items",
      description: "Create custom treasures or heirlooms",
    },
    {
      id: "quest",
      label: "Quests",
      description: "Design personal goals or side quests",
    },
  ];
  ...
  const characterSheetSections = [
    {
      id: "combatStats",
      label: "Combat Stats",
      description: "AC, HP, Speed, Hit Dice",
    },
    {
      id: "abilityScores",
    ...
    },
    {
      id: "savingThrows",
      label: "Saving Throws",
      description: "Proficiencies and bonuses",
    },
    {
      id: "skills",
      label: "Skills",
    ...
    },
    {
      id: "equipment",
      label: "Equipment",
      description: "Weapons, armor, and inventory",
    },
    {
      id: "spells",
      label: "Spellcasting",
      description: "Spells, slots, and cantrips",
    },
    {
      id: "personality",
      label: "Personality",
  ...
  return (
    <div className="space-y-8">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  onClick={() =>
                    updatePlayerSettings({ [section.id]: !isEnabled })
                  }
                >
                  <div
      ...
      <div>
        ...
        <p className="text-sm text-text-muted mb-4">
          Choose which generators are available in player mode. Created content
          goes to your personal library.
        </p>
        <div className="grid grid-cols-2 gap-3">
          {playerGenerators.map((gen) => {
            const key =
              gen.id as keyof typeof playerSettings.enabledPlayerGenerators;
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {characterSheetSections.map((section) => {
            const key =
              section.id as keyof typeof playerSettings.characterSheetSections;
