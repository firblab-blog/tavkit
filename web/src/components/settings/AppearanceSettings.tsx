  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="text-sm text-text-muted mb-4">
          Choose where the main toolbar appears
        </p>
      ...
      <section>
        ...
        <p className="text-sm text-text-muted mb-4">
          Choose how breadcrumb tabs appear on mobile devices (screens smaller
          than 768px)
        </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-text-muted">
                  Tab bar hides when scrolling down, shows when scrolling up or
                  after pausing
                </div>
              </div>
            </div>
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-text-muted mt-1">
              Display AI-generated summaries with key NPCs, locations, and plot
              points
            </p>
          </div>
        </label>
