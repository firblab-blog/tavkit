  ...
  const defaultHomeSections = [
    {
      id: "campaign",
      label: "Campaign",
      description: "Campaign management and overview",
    },
    {
      id: "create",
      label: "Create",
      description: "Content creation tools and generators",
    },
    {
      id: "play",
      label: "Play",
      description: "Session tools like combat tracker",
    },
  ];
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-3 gap-3">
          {defaultHomeSections.map((section) => (
            <button
              ...
              onClick={() =>
                updateGMSettings({
                  defaultHomeSection: section.id as
                    | "campaign"
                    | "create"
                    | "play",
                })
      ...
      <div>
        ...
        <p className="text-sm text-text-muted mb-4">
          Show or hide sections in the campaign toolkit. Hidden sections with
