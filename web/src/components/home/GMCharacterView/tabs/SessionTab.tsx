 ...
 */
export default function SessionTab({ campaignId: _campaignId }: SessionTabProps) {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-text-muted text-sm space-y-1">
              <li>
                • Use <strong>Combat Tracker</strong> for initiative and HP tracking
              </li>
              <li>
                • The <strong>Chat</strong> tab can help generate content on the fly
              </li>
              <li>
                • Run <strong>Social Encounters</strong> for negotiation and diplomacy scenes
              </li>
            </ul>
          </div>
        </div>
