...
export type PlayerTabId = 'overview' | 'journal' | 'loot' | 'combat' | 'library'
...
export default function PlayerTabs({ activeTab, onTabChange, className = '' }: PlayerTabsProps) {
  return (
...
export function MobilePlayerTabBar({ activeTab, onTabChange }: MobileTabBarProps) {
