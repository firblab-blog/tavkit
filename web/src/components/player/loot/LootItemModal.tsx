      ...
      <div className="bg-background-panel border border-border rounded-xl w-full max-w-2xl my-8 relative">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-xl font-bold text-text mb-1">{item.name}</h2>
                {item.quantity > 1 && (
        ...
        <div className="p-6 space-y-6">
          ...
          {isClaimed ? (
            ...
            <div className="flex items-center gap-2 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-yellow-400/70 text-sm">This item has not been claimed yet</p>
              </div>
              <button
                onClick={onClaim}
          ...
          <div className="grid grid-cols-2 gap-4">
            {item.value && (
              <div>
                <h4 className="text-xs font-medium text-text-muted uppercase mb-1">Value</h4>
            ...
            {item.source && (
              <div className="col-span-2">
                <h4 className="text-xs font-medium text-text-muted uppercase mb-1">Source</h4>
                <p className="text-text flex items-center gap-1.5">
