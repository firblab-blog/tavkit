      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-tavern-mauve mt-1">AI-generated overview of your campaign</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            <Icon name="Settings" className="w-5 h-5 text-tavern-mauve hover:text-primary" />
          </button>
      ...
      {showProgress ? (
        ...
        <div className="flex items-center justify-center py-12 bg-background-panel border border-border rounded-lg">
          <div className="text-center">
            ...
            <p className="text-sm text-tavern-mauve mt-2">This may take a minute</p>
          </div>
        </div>
        ...
        <div className="text-center py-12 bg-background-panel border border-dashed border-border rounded-lg">
          <Icon name="Sparkles" className="w-16 h-16 text-tavern-mauve mx-auto mb-3 opacity-50" />
          <p className="text-tavern-mauve mb-4">No campaign summary generated yet</p>
