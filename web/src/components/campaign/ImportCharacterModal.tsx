        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-8">
              <Icon
                name="Users"
                className="w-12 h-12 text-tavern-mauve mx-auto mb-3 opacity-50"
              />
              <p className="text-tavern-mauve">
                No characters available to import
              </p>
              <p className="text-sm text-tavern-mauve mt-1">
                All your characters are already in this campaign, or you haven't
                created any yet.
              </p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    >
                      {selectedIds.has(character.id) && (
                        <Icon
                          name="Check"
                          className="w-3 h-3 text-tavern-darkest"
                        />
                      )}
                    </div>
                    ...
                    <div className="w-12 h-12 rounded-full bg-tavern-dark flex items-center justify-center overflow-hidden">
                      {character.avatar ? (
                        ...
                        <Icon
                          name="User"
                          className="w-6 h-6 text-tavern-mauve"
                        />
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-tavern-light truncate">
                        {character.name}
                      </h4>
