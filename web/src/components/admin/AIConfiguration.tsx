...
export default function AIConfiguration() {
  ...
  const handleSwitchProvider = async () => {
    ...
    try {
      ...
      setSwitchingError(err instanceof Error ? err.message : 'Failed to switch provider')
    } finally {
  ...
  return (
    <section className="bg-background-panel border border-border rounded-lg p-6">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h3 className="text-lg font-semibold text-text mb-4">Active AI Provider</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-text mb-2 block">Current Provider</label>
            ...
            <button
              ...
              disabled={
                switchingSaving || !selectedProvider || selectedProvider === currentProvider
              }
        ...
        <div>
          <h3 className="text-lg font-semibold text-text mb-4">Performance Settings</h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted mt-2">
                Maximum time to wait for AI generation requests (30-600 seconds). Increase for
                complex generations or slower hardware.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-text-muted mt-2">
                Custom Ollama server URL. Leave empty to use the default environment configuration (
        ...
        <div>
          <h3 className="text-lg font-semibold text-text mb-4">About AI Providers</h3>
          <div className="space-y-3">
            <div className="p-4 bg-background rounded-lg border border-border">
              ...
              <p className="text-xs text-text-muted">
                Self-hosted AI running on your own hardware. Uses the Go backend directly for
                maximum performance (same architecture as Anthropic/OpenAI). Configured via
          ...
          <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
            <p className="text-xs text-text-muted flex items-start gap-2">
              <Icon name="AlertCircle" className="w-3 h-3 mt-0.5 text-yellow-500 flex-shrink-0" />
              <span>
                <span className="font-medium text-text">Note:</span> Providers must be configured in
                your .env file before deployment. This interface only allows switching between
                already-configured providers and adjusting runtime performance settings.
              </span>
            </p>
          </div>
        </div>
