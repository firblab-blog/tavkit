...
export const usePartyLootStore = create<PartyLootState>((set, get) => ({
  ...
  fetchLoot: async (campaignId: string) => {
    ...
    try {
      const response = await apiClient.get(
        `/campaigns/${campaignId}/party-loot`,
      );
  ...
  updateLoot: async (
    ...
    try {
      ...
      const response = await apiClient.put(
        `/campaigns/${campaignId}/party-loot/${id}`,
        updateData,
      );
  ...
  claimLoot: async (
    ...
    try {
      const response = await apiClient.put(
        `/campaigns/${campaignId}/party-loot/${id}/claim`,
        claim,
      );
      const updatedItem = response.data as PartyLootItem;
